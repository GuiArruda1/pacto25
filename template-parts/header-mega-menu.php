...
$default_col1 = array(
    array( 'title' => 'seguro automóvel', 'url' => '#seguro-automovel' ),
    array( 'title' => 'seguro multirriscos casa', 'url' => '#seguro-multirriscos-casa' ),
    array( 'title' => 'seguro multirriscos condomínio', 'url' => '#seguro-multirriscos-condominio' ),
    array( 'title' => 'seguro poupança reforma', 'url' => '#seguro-poupanca-reforma' ),
    array( 'title' => 'seguro embarcações de recreio', 'url' => '#seguro-embarcacoes-recreio' ),
);

// Default Column 2 links
$default_col2 = array(
    array( 'title' => 'seguro de vida', 'url' => '#seguro-vida' ),
    array( 'title' => 'seguro empregada doméstica', 'url' => '#seguro-empregada-domestica' ),
    array( 'title' => 'seguro acidentes pessoais', 'url' => '#seguro-acidentes-pessoais' ),
    array( 'title' => 'seguro de saúde', 'url' => '#seguro-saude' ),
);

// Default Column 3 links
$default_col3 = array(
    array( 'title' => 'seguro para desporto', 'url' => '#seguro-desporto' ),
    array( 'title' => 'seguro de viagem', 'url' => '#seguro-viagem' ),
    array( 'title' => 'seguro de reposição salarial', 'url' => '#seguro-reposicao-salarial' ),
    array( 'title' => 'seguro erasmus', 'url' => '#seguro-erasmus' ),
);

// Default Column 4 links
$default_col4 = array(
    array( 'title' => 'seguro para animais de estimação', 'url' => '#seguro-animais-estimacao' ),
    array( 'title' => 'seguro caçadores e porte de arma', 'url' => '#seguro-cacadores-porte-arma' ),
    array( 'title' => 'seguro alojamento local', 'url' => '#seguro-alojamento-local' ),
    array( 'title' => 'seguro senhorios', 'url' => '#seguro-senhorios' ),
);
