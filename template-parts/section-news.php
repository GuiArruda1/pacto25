...
<section class="section section-news" id="noticias"
    aria-label="<?php esc_attr_e('Notícias e Eventos', 'pacto-25'); ?>">
        ...
        <div class="news-layout">
            ...
            <div class="news-visual">
                ...
                <div class="news-visual__photo-wrap">
                    ...
                    <?php else: ?>
                        <img src="<?php echo esc_url($default_img); ?>" class="news-image"
                            alt="<?php echo esc_attr($title); ?>" width="370" height="370" loading="lazy"
                            decoding="async" />
                    <?php endif; ?>
                </div>
            </div>
