<?php
/**
 * Template Part: Particulares - Seguros List Grid Section
 * Theme: Pacto 25
 * 
 * Strict Agency SOP:
 * - Dynamic WP_Query over CPT 'seguro_particular'
...
$posts_per_page = (int) pacto_get_field( 'particulares_seguros_per_page', false, 8 );
...
$default_seguros = array(
    array(
        ...
        'btn_text'    => 'saber mais',
        'btn_url'     => pacto_get_seguro_particular_url( 'multirriscos-casa' ),
    ...
    array(
        ...
        'desc'        => 'Enim amet nullam dictumst dui amet. Sit tellus morbi ut auctor. Aliquet eu proin non netus nisl nascetur sed duis in, lorem ipsum dolor sit amet consectetur.',
        'btn_text'    => 'saber mais',
        'btn_url'     => pacto_get_seguro_particular_url( 'automovel' ),
    ...
    array(
        ...
        'desc'        => 'Enim amet nullam dictumst dui amet. Sit tellus morbi ut auctor. Aliquet eu proin non netus nisl nascetur sed duis in, lorem ipsum dolor sit amet consectetur.',
        'btn_text'    => 'saber mais',
        'btn_url'     => pacto_get_seguro_particular_url( 'animais-estimacao' ),
    ...
    array(
        ...
        'desc'        => 'Enim amet nullam dictumst dui amet. Sit tellus morbi ut auctor. Aliquet eu proin non netus nisl nascetur sed duis in, lorem ipsum dolor sit amet consectetur.',
        'btn_text'    => 'saber mais',
        'btn_url'     => pacto_get_seguro_particular_url( 'poupanca-reforma' ),
    ...
    array(
        ...
        'desc'        => 'Enim amet nullam dictumst dui amet. Sit tellus morbi ut auctor. Aliquet eu proin non netus nisl nascetur sed duis in, lorem ipsum dolor sit amet consectetur.',
        'btn_text'    => 'saber mais',
        'btn_url'     => pacto_get_seguro_particular_url( 'saude' ),
    ...
    array(
        ...
        'desc'        => 'Enim amet nullam dictumst dui amet. Sit tellus morbi ut auctor. Aliquet eu proin non netus nisl nascetur sed duis in, lorem ipsum dolor sit amet consectetur.',
        'btn_text'    => 'saber mais',
        'btn_url'     => pacto_get_seguro_particular_url( 'viagem' ),
    ...
    array(
        ...
        'desc'        => 'Enim amet nullam dictumst dui amet. Sit tellus morbi ut auctor. Aliquet eu proin non netus nisl nascetur sed duis in, lorem ipsum dolor sit amet consectetur.',
        'btn_text'    => 'saber mais',
        'btn_url'     => pacto_get_seguro_particular_url( 'acidentes-pessoais' ),
    ...
    array(
        ...
        'desc'        => 'Enim amet nullam dictumst dui amet. Sit tellus morbi ut auctor. Aliquet eu proin non netus nisl nascetur sed duis in, lorem ipsum dolor sit amet consectetur.',
        'btn_text'    => 'saber mais',
        'btn_url'     => pacto_get_seguro_particular_url( 'desporto' ),
        'image_file'  => 'desporto.png',
    ),
);
?>

<section class="section section-particulares-seguros" aria-label="<?php esc_attr_e( 'Lista de Seguros para Particulares', 'pacto-25' ); ?>">
    <div class="site-container">
        <div class="particulares-seguros__grid">
        ...
        <!-- Numbered Pagination -->
        <nav class="particulares-pagination" aria-label="<?php esc_attr_e( 'Navegação de páginas de seguros', 'pacto-25' ); ?>">
